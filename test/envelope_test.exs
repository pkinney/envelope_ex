defmodule EnvelopeTest do
  ...
  test "create an Envelope from Polygon" do
    ...
    assert Envelope.from_geo(geo) === %Envelope{ min_x: 2,
                                                 min_y: -2,
                                                 max_x: 20,
                                                 max_y: 11 }
  end
  ...
  test "detect an empty Envelope" do
    ...
    refute Envelope.empty? Envelope.from_geo(%Geo.Polygon{coordinates: [[{2, -2}, {20, -2}, {11, 11}, {2, -2}]]})
  end
